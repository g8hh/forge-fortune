...
var BM909 = function (_Buff42) {
    _inherits(BM909, _Buff42);
...
var BM909A1 = function (_Buff43) {
    _inherits(BM909A1, _Buff43);
...
var BM909B1 = function (_Buff44) {
    _inherits(BM909B1, _Buff44);
...
var BM909C1 = function (_Buff45) {
    _inherits(BM909C1, _Buff45);
...
var BM909A2 = function (_Buff46) {
    _inherits(BM909A2, _Buff46);
...
var BM909B2 = function (_Buff47) {
    _inherits(BM909B2, _Buff47);
...
var BM909C2 = function (_Buff48) {
    _inherits(BM909C2, _Buff48);
...
var BM909C3 = function (_Buff49) {
    _inherits(BM909C3, _Buff49);
...
var BM910 = function (_Buff50) {
    _inherits(BM910, _Buff50);
...
var BM910A = function (_Buff51) {
    _inherits(BM910A, _Buff51);
...
var Hero = function (_Combatant) {
    ...
    _createClass(Hero, [{
        ...
        value: function getPow(noBuff, skillID) {
            ...
            if (noBuff) return Math.max(1, this.initialPow + trophyBuff + this.gearSlots.map(function (g) {
                return g.pow()
            }).reduce(function (a, b) {
                return a + b
            }));
        ...
        value: function maxHP(noBuff) {
            ...
            if (noBuff) return Math.max(1, this.initialHP + trophyBuff + this.gearSlots.map(function (g) {
                return g.hp()
            }).reduce(function (a, b) {
                return a + b
            }));
...
$(document).on("click", ".trophyEquipButton", function (e) {
    e.preventDefault();
...
$(document).on("click", ".trophyBackButton", function (e) {
    e.preventDefault();
    $(".tabcontent").hide();
    $("#heroesTab").show()
});
...
function heroCurrentGearEquip(hero, gearSlot) {
    ...
    if (gear === null) {
        ...
        var _equipStats2 = $("<div/>").addClass("emptyEquipStats").appendTo(_d2);
...
function heroEquipCard(hero, itemContainer) {
    ...
    for (var _i3 = 0, _Object$entries3 = Object.entries(itemContainer.itemStat()); _i3 < _Object$entries3.length; _i3++) {
        var _Object$entries3$_i = _slicedToArray(_Object$entries3[_i3], 2),
...
$(document).on("click", ".equipTrophy", function (e) {
    e.preventDefault();
    equipTrophies()
});
"use strict";
...
var itemContainer = function () {
    ...
    _createClass(itemContainer, [{
        ...
        value: function picName() {
            var sharp = this.sharp > 0 ? "".concat(miscIcons.enhancement).concat(this.sharp) : null;
        ...
        value: function picNamePlus() {
            var sharp = '<span class="item-prefix">'.concat(miscIcons.enhancement).concat(this.sharp + 1, "</span>");
...
var FusionManager = {
    ...
    maxSlots: function maxSlots() {
        var firstUpgrade = Shop.alreadyPurchased("AL3006") ? 1 : 0;
        var secondUpgrade = Shop.alreadyPurchased("AL3012") ? 1 : 0;
...
function refreshFuseSlots() {
    ...
    FusionManager.slots.forEach(function (slot) {
        ...
        slot.fb = undefined;
        slot.ff = undefined;
        var d1 = $("<div/>").addClass("fuseSlot").addClass("R" + slot.rarity).addClass("ctrlClickItem").data("rid", slot.id);
...
function refreshPossibleFuse() {
    ...
    if (Inventory.getFusePossibilities().length > 0) {
        Inventory.getFusePossibilities().forEach(function (f) {
            ...
            var fuseSelect = $("<div/>").addClass("fuseSelect R".concat(f.rarity - 1)).addClass("ctrlClickItem").data("rid", f.id).appendTo(d3);
...
function itemCardSmith(item, location) {
    ...
    var itemdiv = $("<div/>").addClass("smithItem").addClass("R" + item.rarity).addClass("ctrlClickItem").data("rid", item.id);
...
function createFortuneInv(item) {
    var itemdiv = $("<div/>").addClass("fortuneItem").addClass("R" + item.rarity).addClass("ctrlClickItem").data("rid", item.id);
    var itemName = $("<div/>").addClass("itemName").html(item.picName());
    var itemLevel = $("<div/>").addClass("itemLevel").html(item.itemLevel());
...
var SynthManager = {
    ...
    amt: function amt() {
        if (this.setting === synthToggle.DESYNTH) {
            ...
            return Math.floor(this.slot.item.craftTime / 4e3 * miscLoadedValues.fuelGainRate[this.slot.rarity - 1])
        }
        if (this.setting === synthToggle.RESYNTH) {
            if (this.slot === null) return 0;
            if (this.slot.rarity === 0) return Math.max(1, Math.floor(this.slot.item.craftTime / 4e3 * .5));
            return Math.floor(this.slot.item.craftTime / 4e3 * miscLoadedValues.fuelGainRate[this.slot.rarity - 1])
        }
    },
    ...
    updateSynthTimeRemainingTooltip: function updateSynthTimeRemainingTooltip() {
        this.remainingTime = msToTime(this.fuel * 1e3)
    }
};
...
function generateSynthBoost() {
    ...
    $("<div/>").addClass("synthBoostHeaderIcon tooltip").attr({
    ...
    $("<div/>").addClass("synthBoostCount tooltip").attr({
        id: "synthBoostRemaining",
        "data-tooltip": "synth_time_remaining",
...
function refreshSynthBoost(manual) {
    ...
    $("#synthBoostRemaining").html("".concat(formatToUnits(SynthManager.fuel, 2), " ").concat(miscIcons.essence, " Remaining"));
    SynthManager.updateSynthTimeRemainingTooltip()
}
...
$(document).on("click", "#synthBoostDesc", function (e) {
    e.preventDefault();
...
function generateContributionsList(recipe, skipAnimation) {
    ...
    var museumContributionsList = $("<div/>").addClass("museumContributionsListRecipe").appendTo($museumRecipeContributions);
...
$(document).on("click", ".museumRecipeSelection", function (e) {
...
$(document).on("click", ".museumRecipeCycleLeft", function (e) {
    museumRecipeCycleLeft();
    generateContributionsList(Museum.itemInspect, true)
});
$(document).on("click", ".museumRecipeCycleRight", function (e) {
...
$(document).on("click", ".museumRecipeBackButton", function (e) {
    e.preventDefault();
    var recipe = Museum.itemInspect;
...
var ExpeditionManager = {
    ...
    collect: function collect(eid) {
        ...
        this.quests.forEach(function (quest) {
            return quest.playbookUnlock(expedition.party, expedition.goal)
        });
    ...
    heroLocked: function heroLocked(heroID) {
        return this.expeditions.map(function (e) {
            return e.party
        }).some(function (e) {
...
var Quest = function () {
    ...
    _createClass(Quest, [{
        ...
        key: "playbookUnlock",
        value: function playbookUnlock(party, landmark) {
            if (!this.unlocked() || this.complete()) return;
            if (landmark < this.landmark) return;
            var questParty = [this.hero1];
...
function refreshExpeditionList() {
    ...
    }).html(displayText("button_more_info")).appendTo(contentHeader);
...
function refreshExpeditionParty() {
    ...
    var expeditionEmbark = $("<div/>").addClass("expeditionEmbarkContainer").appendTo($expeditionParty);
    ...
    var q = $("<div/>").addClass("expeditionQuests").appendTo($expeditionParty);
    var questContentHeader = $("<div/>").addClass("contentHeader").appendTo(q);
    var questHeadingDetails = $("<div/>").addClass("headingDetails").appendTo(questContentHeader);
    ...
    $("<div/>").addClass("headingMoreInfoButton tooltip").attr({
        "data-tooltip": "more_info_expedition_quest"
    }).html(displayText("button_more_info")).appendTo(questContentHeader);
    if (ExpeditionManager.availableQuests().length === 0) $("<div/>").addClass("emptyContentMessage").html(displayText("expedition_party_quest_none")).appendTo(q);
        ...
        var expeditionQuests = $("<div/>").addClass("expeditionQuestsContainer").appendTo(q);
        ExpeditionManager.availableQuests().forEach(function (quest) {
...
function refreshExpeditionPartyStats() {
    ...
    s.empty();
    var stats = $("<div/>").addClass("heroStats").appendTo(s);
    var powStat = $("<div/>").addClass("heroStat").appendTo(stats);
    ...
    var hptat = $("<div/>").addClass("heroStat").appendTo(stats);
    ...
    $("<div/>").addClass("expEfficiency heroStat").html("".concat((ExpeditionManager.efficiency() * 100).toFixed(0), "% Efficiency")).appendTo(stats)
}
...
function createExpeditionPartyQuest(quest) {
    var d = $("<div/>").data("qid", quest.id).addClass("expeditionPartyQuest");
    $("<div/>").addClass("expeditionPartyQuestName").html(quest.name).appendTo(d);
    var d1 = $("<div/>").addClass("expeditionpartyQuestMembers").appendTo(d);
    var hero1 = HeroManager.idToHero(quest.hero1).head;
    $("<div/>").addClass("expeditionpartyQuestMemberHead").html(hero1).appendTo(d1);
    if (quest.hero2 !== null) {
        var hero2 = HeroManager.idToHero(quest.hero2).head;
        $("<div/>").addClass("expeditionpartyQuestMemberHead").html(hero2).appendTo(d1)
    }
    if (quest.hero3 !== null) {
        var hero3 = HeroManager.idToHero(quest.hero3).head;
        $("<div/>").addClass("expeditionpartyQuestMemberHead").html(hero3).appendTo(d1)
    }
    if (quest.hero4 !== null) {
        var hero4 = HeroManager.idToHero(quest.hero4).head;
...
function createNewExpeditionListing(expedition) {
    ...
    $("<div/>").addClass("expeditionReward").attr("id", "expreward" + expedition.id).html("Next Reward: ".concat(miscIcons.gold, " ").concat(expedition.goldReward(true))).appendTo(d);
...
$(document).on("click", ".expeditionCollect", function (e) {
    e.preventDefault();
    var eid = parseInt($(e.currentTarget).data("eid"));
    ExpeditionManager.collect(eid);
    refreshExpeditionList()
});
$(document).on("click", "#newExpedition", function (e) {
    e.preventDefault();
    ExpeditionManager.partyBuild = [];
    refreshExpeditionParty()
});
$(document).on("click", ".heroExpedition", function (e) {
    e.preventDefault();
    var hid = $(e.currentTarget).data("hid");
...
function renderDialogActions(id) {
    ...
    if (id === "settings") {
        ...
        var durations = [5e3, 1e4, 15e3];
        durations.forEach(function (duration, i) {
            var label = $("<label/>").addClass("selection-container toastDurationSelection").html("".concat(duration / 1e3, " seconds"));
            $("<input/>").attr({
                type: "radio",
                name: "toastDuration",
                value: duration,
